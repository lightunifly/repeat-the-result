...
u2=u1+tf.reduce_sum(tf.square(deltau1),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau1,deltaW[:,1,:]),axis=1)
...
u3=u2+tf.reduce_sum(tf.square(deltau2),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau2,deltaW[:,2,:]),axis=1)
...
u4=u3+tf.reduce_sum(tf.square(deltau3),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau3,deltaW[:,3,:]),axis=1)
...
u5=u4+tf.reduce_sum(tf.square(deltau4),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau4,deltaW[:,4,:]),axis=1)
...
u6=u5+tf.reduce_sum(tf.square(deltau5),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau5,deltaW[:,5,:]),axis=1)
...
u7=u6+tf.reduce_sum(tf.square(deltau6),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau6,deltaW[:,6,:]),axis=1)
...
u8=u7+tf.reduce_sum(tf.square(deltau7),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau7,deltaW[:,7,:]),axis=1)
...
u9=u8+tf.reduce_sum(tf.square(deltau8),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau8,deltaW[:,8,:]),axis=1)
...
u10=u9+tf.reduce_sum(tf.square(deltau9),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau9,deltaW[:,9,:]),axis=1)
...
u11=u10+tf.reduce_sum(tf.square(deltau10),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau10,deltaW[:,10,:]),axis=1)
...
u12=u11+tf.reduce_sum(tf.square(deltau11),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau11,deltaW[:,11,:]),axis=1)
...
u13=u12+tf.reduce_sum(tf.square(deltau12),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau12,deltaW[:,12,:]),axis=1)
...
u14=u13+tf.reduce_sum(tf.square(deltau13),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau13,deltaW[:,13,:]),axis=1)
...
u15=u14+tf.reduce_sum(tf.square(deltau14),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau14,deltaW[:,14,:]),axis=1)
...
u16=u15+tf.reduce_sum(tf.square(deltau15),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau15,deltaW[:,15,:]),axis=1)
...
u17=u16+tf.reduce_sum(tf.square(deltau16),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau16,deltaW[:,16,:]),axis=1)
...
u18=u17+tf.reduce_sum(tf.square(deltau17),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau17,deltaW[:,17,:]),axis=1)
...
u19=u18+tf.reduce_sum(tf.square(deltau18),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau18,deltaW[:,18,:]),axis=1)
...
u20=u19+tf.reduce_sum(tf.square(deltau19),axis=1)*deltaT+np.sqrt(2.0)*tf.reduce_sum(tf.multiply(deltau19,deltaW[:,19,:]),axis=1)
